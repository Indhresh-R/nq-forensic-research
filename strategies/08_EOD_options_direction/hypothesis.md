# Hypothesis — Prior-Day EOD Options -> Intraday Direction

## Market behavior under test

Causally lagged QQQ options positioning (GEX / PC imbalance / put OI z) creates next-day intraday directional asymmetry.

## Economic / mechanical rationale

Dealer hedging / positioning may skew NQ path after the information becomes available.
