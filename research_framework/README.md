...
Shared rules for every strategy dossier in this repository.

| Doc | Contents |
|-----|----------|
| [causal_rules.md](causal_rules.md) | Information sets, next-bar outcomes |
| [data_specification.md](data_specification.md) | NQ data, sessions, ONR |
| [train_validation_oos.md](train_validation_oos.md) | Chronological splits |
